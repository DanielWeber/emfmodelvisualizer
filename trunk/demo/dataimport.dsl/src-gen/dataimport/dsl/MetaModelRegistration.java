...
public class MetaModelRegistration {
    ...
    static {
		...
		public static void register() {
			String nsURI = "http://www.mycompany.com/dataimport";
			if (EPackage.Registry.INSTANCE.get(nsURI) == null) {
   				try {
					EPackage pack = (EPackage) loadRootObject("dataimport/dsl/imp" + ".ecore");
	...
	public static EPackage getEPackage() {
		return EPackage.Registry.INSTANCE.getEPackage("http://www.mycompany.com/dataimport");
	}
